...
public class Test7 {
	 ...
	 * 分析:
	 * 1.定义一个学生类
	 * 		成员变量:姓名,语文成绩,数学成绩英语成绩,总成绩
	 * 		成员方法:空参构造,有参构造的参数分别是姓名,语文成绩,数学成绩,英语成绩toString方法,在遍历集合中的Student对象打印对象引用的时候会显示属性值
	...
	public static void main(String[] args) {
		...
		while(ts.size() < 5) {
			...
			String[] arr = line.split(",");//用逗号切割录入的字符串
		...
		//7.遍历TreeSet集合打印每一个Student对象(用迭代器迭代)
